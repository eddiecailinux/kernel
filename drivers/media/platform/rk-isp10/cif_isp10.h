...
enum cif_isp10_of_phy {
    ISP_OF_PHY_PARALLEL = 0,
    ISP_OF_PHY_CSIPHY1,
};

enum cif_isp10_isp_pad {
	CIF_ISP10_ISP_PAD_SINK_MIPI,
	CIF_ISP10_ISP_PAD_SINK_DVP,
	CIF_ISP10_ISP_PAD_SINK_DMA,
	CIF_ISP10_ISP_PAD_SOURCE_MP,
	CIF_ISP10_ISP_PAD_SOURCE_SP,
	CIF_ISP10_ISP_PAD_SOURCE_STATS,
	CIF_ISP10_ISP_PAD_MAX
};

enum cif_isp10_sd_type {
	CIF_ISP10_SD_SENSOR = 0,
	CIF_ISP10_SD_PHY_CSI,
	CIF_ISP10_SD_VCM,
	CIF_ISP10_SD_FLASH,
	CIF_ISP10_SD_MAX,
};

#define CIF_ISP10_MAX_BUS_CLK 8
struct cif_isp10_device {
	unsigned int dev_id;
	CIF_ISP10_PLTFRM_DEVICE dev;
	struct clk *isp_clk;
	struct clk *bus_clk[CIF_ISP10_MAX_BUS_CLK];
	struct v4l2_device v4l2_dev;
	struct media_device media_dev;
	struct v4l2_subdev *subdevs[CIF_ISP10_SD_MAX];
	int num_sensors;
	struct v4l2_async_notifier notifier;
	struct v4l2_async_subdev asd;

	struct v4l2_subdev isp_sub_dev;
	struct media_pad pads[CIF_ISP10_ISP_PAD_MAX];
	struct v4l2_ctrl_handler ctrl_handler;
	struct cif_isp10_pipeline pipe;

	struct cif_isp10_stream_subdev mp_strm_subdev;
	struct cif_isp10_stream_subdev sp_strm_subdev;

	enum cif_isp10_pm_state pm_state;
	enum cif_isp10_img_src_state img_src_state; //TODO(zsq): not more img_src

	spinlock_t vbq_lock;	/* spinlock for videobuf queues */
	spinlock_t vbreq_lock;	/* spinlock for videobuf requeues */

	unsigned int img_src_cnt; //TODO(zsq) this always be 1
